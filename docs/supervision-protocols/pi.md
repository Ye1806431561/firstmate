...
Decision-owned and completed-scout signal and stale routing, including attended whole-batch precedence, away takeover, and the independent heartbeat exception, is owned by [docs/pi-supervision-branch.md](../pi-supervision-branch.md#components-and-their-owners).
